...
public class DataProcess extends PreferenceActivity {
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if ( prefixPref == null ) {
        	...
        	EditText prefixEditText = (EditText)prefixPref.getEditText();
        ...
        if ( suffixPref == null ) {
        	...
        	EditText suffixEditText = (EditText)suffixPref.getEditText();
        	InputFilter[] FilterArray = new InputFilter[1];
        	FilterArray[0] = new InputFilter.LengthFilter(11);
        ...
        if ( startPref == null ) {
        	...
        	EditText startEditText = (EditText)startPref.getEditText();
        ...
        if ( noofcharPref == null ) {
        	...
        	EditText noofcharEditText = (EditText)noofcharPref.getEditText();
